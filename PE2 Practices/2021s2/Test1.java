...
class Test1 {
  public static void main(String[] args) throws Throwable {
    ...
    i.expectCompile("Try.<Number>of((Producer<Integer>) () -> 2) compiles without error",
        "cs2030s.fp.Try.<Number>of((cs2030s.fp.Producer<Integer>) () -> 2);",
        true);
    
    i.expectCompile("Producer<Integer> p = () -> 2;\nTry<Number> t = Try.of(p); also compiles without error",
    ...
    i.expectReturn("Try.failure(new ArithmeticException()).equals(Try.failure(new Error())",
        () -> Try.failure(new ArithmeticException()).equals(Try.failure(new Error())),
        false);

    i.expectReturn("Try.failure(new ArithmeticException()).equals(Try.failure(new ArithmeticException())",
